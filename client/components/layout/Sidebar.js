        ...
        <>
            <nav className="h-screen flex flex-col w-64 bg-white-50">
                ...
                <ul className="p-2 space-y-2 flex-1 overflow-auto" >
                    ...
                    <li>
                        <Link to="/hr/region" className="flex space-x-2 items-center text-gray-600 p-2 hover:bg-gray-200 rounded-lg hover:text-gray-900">
                    ...
                    <li>
                        <Link to="/hr/country" className="flex space-x-2 items-center text-gray-600 p-2 hover:bg-gray-200 rounded-lg hover:text-gray-900">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
