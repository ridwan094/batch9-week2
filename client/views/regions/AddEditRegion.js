...
export default function AddEditRegion(props) {
    ...
    useEffect(() => {
        if (props.region.actionType === 'Edit') {
            ...
            apiRegion.findOne(props.region.region_id).then(data => {
                ...
                setValues({ ...values, region_id: data.region_id, region_name: data.region_name })
            })
        } else {
            setValues({ ...values, region_id: undefined, region_name: "" })
        }
    }, [props.region.actionType])
    ...
    const onSubmit = () => {
        ...
        if (props.region.actionType === 'Add') {
            ...
            apiRegion.create(region).then(result => {
                console.log(result);
            })

        } else if (props.region.actionType === 'Edit') {
